...
class HomeStateHolder
    @Inject
    constructor() : StateHolder<Unit, HomeStateHolder.UiState>() {
        ...
        private fun tabs(selectedType: Type): List<HomeTab> =
            buildList {
        ...
        private fun topHeadlines(selected: Boolean) =
            HomeTab(
        ...
        private fun newsSource(selected: Boolean) =
            HomeTab(
        ...
        private fun country(selected: Boolean) =
            HomeTab(
                type = Type.COUNTRY,
        ...
        private fun language(selected: Boolean) =
            HomeTab(
                type = Type.LANGUAGE,
        ...
        private fun search(selected: Boolean) =
            HomeTab(
                type = Type.SEARCH,
